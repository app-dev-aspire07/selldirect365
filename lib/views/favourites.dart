...
class _FavouritesState extends State<Favourites> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: withoutBackAppBar(context, title: "Favorites"),
      body: Obx(
        () => _otherController.isFavorite.value
            ? ListView.builder(
                itemCount: 5, 
            ...
            : _otherController.getFavoriteTrucks.isEmpty
                ...
                children: [
                  ...
                  Expanded(
                    child: ListView.builder(
                      shrinkWrap: true,
                      itemCount: _otherController.getFavoriteTrucks.length,
                      itemBuilder: (context, index) {
                        return Padding(
                            ...
                            onTap: () {
                              Navigator.of(context).push(
                                createRoute(
                                  TruckDetails(
                                    name:
                                        "${_otherController.getFavoriteTrucks[index].year} ${_otherController.getFavoriteTrucks[index].brand} ${_otherController.getFavoriteTrucks[index].model}",
                                    id: _otherController
                                        .getFavoriteTrucks[index]
                                        .truckFormId,
                                  ),
                                ),
                              );
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            Text(
                                              " ${_otherController.getFavoriteTrucks[index].color != null ? _otherController.getFavoriteTrucks[index].color : _otherController.getFavoriteTrucks[index].year} ${_otherController.getFavoriteTrucks[index].brand} ${_otherController.getFavoriteTrucks[index].model} ",
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                SizedBox(
                                                  ...
                                                  child: Text(
                                                    "${_otherController.getFavoriteTrucks[index].address}",
                                                    style: GoogleFonts.inter(
                                                      fontSize: 10.sp,
                                                      color: AppColors.black,
                                                      fontWeight:
                                            ...
                                            SizedBox(
                                              ...
                                              child: Text(
                                                " ${_otherController.getFavoriteTrucks[index].desc ?? ""}",
                                                style: GoogleFonts.inter(
                                                  fontSize: 10.sp,
